            ...
            <div className="max-w-7xl mx-auto bg-white bg-opacity-70 backdrop-blur-md rounded-2xl p-6 space-y-6">
                    ...
                    <>
                        ...
                        {allExams.length > 0 && (
                            <div className="mt-6 space-y-4">
                                <h3 className="text-xl font-semibold text-gray-800">Select Your {category.toUpperCase()} Exams</h3>
                                {grouped.map((g, i) => (
                ...
                {view === 'cards' && (
                    <>
                        ...
                        {hasAnySpecial &&
                            <p className="mt-6 text-red-600 font-bold">*Your updated exam time due to clashes - check
                                emails for FCS details though.</p>}
                        <p className="text-orange-500 font-bold">Even if there shouldn't be any mistakes, I don't take
